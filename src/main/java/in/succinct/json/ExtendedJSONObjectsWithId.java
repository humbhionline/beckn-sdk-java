...
public class ExtendedJSONObjectsWithId<T extends ExtendedJSONObjectWithId> extends ExtendedJSONObjects<T> {
    public ExtendedJSONObjectsWithId(){
        this(new JSONArray());
    }
    public ExtendedJSONObjectsWithId(JSONArray array){
        super(array);
        loadMap();
    }
    public ExtendedJSONObjectsWithId(String payload){
        super(payload);
        loadMap();
    }
